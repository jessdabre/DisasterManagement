function showDescs(disaster) {
    const descs = {
        Disasters: ['Emergency Alerts', 'Drought', 'Earthquake','Floods', 'Tsunamis'],
        Make: ['description 1', 'description 2', 'description 3'],
        Get: ['description 1', 'description 2', 'description 3'],
